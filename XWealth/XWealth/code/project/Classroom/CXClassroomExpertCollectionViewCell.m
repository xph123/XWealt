//
//  CXClassroomExpertCollectionViewCell.m
//  XWealth
//
...
@implementation CXClassroomExpertCollectionViewCell
...
-(void)setExpertModel:(CXExpertModel *)expertModel
{
    ...
    _layout = [[CXClassroomExpertCellFrame alloc] initWithDataModel:expertModel];
