//
//  CXSecondhandMarketBannerCell.m
//  XWealth
//
...
@implementation CXSecondhandMarketBannerCell
...
- (void)initSubviews
{
    ...
    CXSecondhandMarketBannerCellFrame *layer=[[CXSecondhandMarketBannerCellFrame alloc]init];
