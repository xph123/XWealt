//
//  CXTrustTransferCenterDetailTableView.m
//  XWealth
//
...
@implementation CXTrustTransferCenterDetailTableView
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    CXTrustTransferCenterDetailCell *cell = [tableView dequeueReusableCellWithIdentifier:InformationCellIdentifier];
    if (cell == nil) {
        cell = [[CXTrustTransferCenterDetailCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:InformationCellIdentifier];
        }
    if (_sourceDatas.count!=0&_sourceDatas!=nil) {
        CXBenefitRecordModel *model = [_sourceDatas objectAtIndex:indexPath.row];
        cell.benefitRecordModel = model;
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (_sourceDatas.count!=0) {
        CXBenefitRecordModel *model = [_sourceDatas objectAtIndex:indexPath.row];
        CXTrustTransferCenterDetailCellFrame *cellFrame = [[CXTrustTransferCenterDetailCellFrame alloc] initWithDataModel:model];
