...
@implementation CXBenefitReleaseCellFrame
...
- (CGFloat)titlelabelHight
{
    ...
    CGSize size = [self.benefitModel.name getSizeWithWidth:width fontSize:kMiddleTextFontSize];
