//
//  CXSearchMyTrackViewController.m
//  XWealth
//
...
@interface CXSearchMyTrackViewController ()
{
...
@implementation CXSearchMyTrackViewController
...
- (void)viewDidLoad
{
    ...
    CXSearchMyTrackView *conditionView = [[CXSearchMyTrackView alloc] initWithFrame:frameView];
...
- (void)didSelectItemAtIndex:(id)data
{
    ...
    __unsafe_unretained CXSearchMyTrackViewController *weak_self = self;
