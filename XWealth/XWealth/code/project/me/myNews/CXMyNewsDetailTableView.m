...
@implementation CXMyNewsDetailTableView
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    CXMyNewsDetailCell *cell = [tableView dequeueReusableCellWithIdentifier:subscribeCellIdentifier];
    if (cell == nil) {
        cell = [[CXMyNewsDetailCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:subscribeCellIdentifier];
    }
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (_sourceDatas.count!=0) {
        ...
        CXMyNewsDetailCellFrame *cellFrame = [[CXMyNewsDetailCellFrame alloc] initWithDataModel:model];
