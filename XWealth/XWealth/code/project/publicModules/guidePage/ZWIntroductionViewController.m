...
- (void)viewDidLoad {
    ...
    if (!self.enterButton) {
        ...
        [self.enterButton setTitle:NSLocalizedString(@"立即开启", nil) forState:UIControlStateNormal];
        //[self.enterButton setBackgroundImage:[UIImage imageNamed:@"guide_button"] forState:UIControlStateNormal];
