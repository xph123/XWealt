...
@interface XSlideSwitchView : UIView<UIScrollViewDelegate>
{
 ...
 * @result tab个数
 */
- (NSUInteger)numberOfTab:(XSlideSwitchView *)view;
 ...
 */
- (UIViewController *)slideSwitchView:(XSlideSwitchView *)view viewOfTab:(NSUInteger)number;
 ...
 * @result 
 */
- (void)slideSwitchView:(XSlideSwitchView *)view panLeftEdge:(UIPanGestureRecognizer*) panParam;
 ...
 * @result
 */
- (void)slideSwitchView:(XSlideSwitchView *)view panRightEdge:(UIPanGestureRecognizer*) panParam;
 ...
 * @result 
 */
- (void)slideSwitchView:(XSlideSwitchView *)view didselectTab:(NSUInteger)number;
