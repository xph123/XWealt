...
@implementation KDGoalSimpleBar
...
-(void)layoutSubviews {
    ...
    if ([customText length] != 0) {
        ...
        float percent = percentLayer.percent * 100;
        [percentLabel setText:[NSString stringWithFormat:@"%.01f%%", percent]];
    } else {
    ...
    CGRect titleFrame = labelFrame;
    titleFrame.origin.y -= 30;
    titleLabel.frame = titleFrame;
    
    CGRect failFrame = labelFrame;
    failFrame.origin.y += 30;
    failLabel.frame = failFrame;
...
-(void)setup {
    ...
    bg = [UIImage imageNamed:@"simple_outline"];
    ...
    percentLayer.color = UIColorFromRGB(0xFF1E00);
    percentLayer.innerRadius = self.frame.size.width / 2 - 2;
    percentLayer.outerRadius = self.frame.size.width / 2;
    ...
    titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 125, 125)];
    [titleLabel setFont:[UIFont fontWithName:@"Futura-CondensedMedium" size:14]];
    //    [titleLabel setTextColor:[UIColor colorWithRed:89/255.0 green:89/255.0 blue:89/255.0 alpha:1.0]];
    [titleLabel setTextColor:kColorWhite];
    ...
    [percentLabel setFont:[UIFont fontWithName:@"Futura-CondensedMedium" size:16]];
    [percentLabel setTextColor:UIColorFromRGB(0xFF1E00)];
    //    [percentLabel setTextColor:UIColorFromRGB(0xF8B72E)]; //[UIColor colorWithRed:89/255.0 green:89/255.0 blue:89/255.0 alpha:1.0]];
    ...
    failLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 125, 125)];
    [failLabel setFont:[UIFont fontWithName:@"Futura-CondensedMedium" size:14]];
    //    [failLabel setTextColor:[UIColor colorWithRed:89/255.0 green:89/255.0 blue:89/255.0 alpha:1.0]];
    [failLabel setTextColor:kColorWhite];
    [failLabel setTextAlignment:NSTextAlignmentCenter];
    [failLabel setBackgroundColor:[UIColor clearColor]];
    failLabel.adjustsFontSizeToFitWidth = YES;
...
//设置字体大小；
- (void)setPercentLabFont:(NSInteger)titleFont
{
    [percentLabel setFont:[UIFont fontWithName:@"Futura-CondensedMedium" size:titleFont]];
}
