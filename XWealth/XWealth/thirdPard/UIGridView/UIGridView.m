...
//    [row setBackgroundColor:[CSFunction getImageColor:[CSFunction buildImageImageActualCombat:@"project_bg"]]];
    //row.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"project_bg"]];
//    row.backgroundColor = UIColorFromRGB(0x3e4045);
