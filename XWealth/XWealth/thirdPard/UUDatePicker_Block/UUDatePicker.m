...
@property (nonatomic, copy) DidLeftBlock didLeftBlock;
@property (nonatomic, copy) DidRightBlock didRightBlock;
@end
...
//        [view addSubview:leftBtn];
        ...
        rightBtn.frame=CGRectMake(self.frame.size.width-60, 0, 60, 30);
...
-(void)setLeftButton:(DidLeftBlock)didLeftBlock
{
    self.didLeftBlock=didLeftBlock;

}
-(void)setRightButton:(DidRightBlock)didRightBlock
{
    self.didRightBlock=didRightBlock;
...
{
    self.didLeftBlock();
    //[self.delegate didLeftButton];
}
-(void)rightbuttonClick
{
    NSString *strWeekDay = [self getWeekDayWithYear:yearArray[yearIndex] month:monthArray[monthIndex] day:dayArray[dayIndex]];
    self.didRightBlock(yearArray[yearIndex],
                       monthArray[monthIndex],
                       dayArray[dayIndex],
                       hourArray[hourIndex],
                       minuteArray[minuteIndex],
                       strWeekDay);
    //[self.delegate didRightButton];
}
